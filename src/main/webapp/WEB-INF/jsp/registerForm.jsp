...
<div class="container">
    ...
    <div class="col-md-6 col-md-offset-3">
        <div class="panel panel-default content-main">
            ...
            <form id="uesr-info" name="userInfo" method="post" action="/user/" onsubmit="return validateForm()">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" id="password" name="password" placeholder="비밀번호는 4~15자 제한입니다">
